...
using static LIMS_Backend.Model.UserFormRightsModel;
...
namespace LIMS_Backend.Model
{
    ...
    public class user_master
    {
        ...
        public int usercode { get => user_code; set => user_code = value; }
    ...
    [Table("mastertenant.user_department_master")]
    public class UserDepartmentMaster
    {
        [Key]
    ...
    public class UserProfileFormModel
    {
        ...
        public IList<UserBranchMaster>? branch { get; set; }
        public IList<UserDepartmentMaster>? department { get; set; }
    }
    ...
    public class LoginResponse
    {
        ...
        public IList<App_User_Rights> rights { get; set; } = new List<App_User_Rights>();
    }
    ...
    public class LoginResult
    {
        ...
        public IList<App_User_Rights> Rights { get; private set; } = new List<App_User_Rights>();
        public IList<UserBranchMaster> Branches { get; set; } = new List<UserBranchMaster>();

        public static LoginResult Fail(string message) =>
            new() { Success = false, Message = message };

        public static LoginResult Ok(user_master user, IList<App_User_Rights> rights, IList<UserBranchMaster> branches) =>
            new() { Success = true, Message = "OK", User = user, Rights = rights, Branches = branches };
    }
