...
namespace medico_backend.Model
{
    ...
    public class ResultEntryModel
    {
        ...
        public IList<Booking.Models.ReportMethodModel> methods { get; set; } = new List<Booking.Models.ReportMethodModel>();
    }
